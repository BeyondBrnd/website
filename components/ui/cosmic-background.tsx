...
interface CosmicBackgroundProps {
    variant?: 'aurora' | 'cosmic' | 'neon' | 'growth';
    intensity?: number;
    speed?: number;
    interactive?: boolean;
...
const CosmicBackground: React.FC<CosmicBackgroundProps> = ({
    ...
    const variantConfigs = {
        ...
        growth: {
            colors: ['#021a0d', '#072e17', '#0f4d26', '#00bf63', '#66ffb3'],
            flowSpeed: 0.1,
            complexity: 3.8,
            waveCount: 5,
            glowIntensity: 2.0
    ...
    useEffect(() => {
        ...
        const qualitySettings = {
            ...
            high: { pixelRatio: Math.min(window.devicePixelRatio, 1.5), precision: 'highp' as const, octaves: 5 },
            ultra: { pixelRatio: Math.min(window.devicePixelRatio, 2), precision: 'highp' as const, octaves: 6 }
        };
    ...
    }, [variant, intensity, speed, interactive, quality, webGLSupported, config.colors, config.complexity, config.flowSpeed, config.glowIntensity, config.waveCount]);
